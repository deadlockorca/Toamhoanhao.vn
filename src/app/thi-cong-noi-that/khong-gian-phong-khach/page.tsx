...
import { ArrowRight, Armchair, Cpu, Factory, Hammer, Phone, Sofa, Sparkles, Wrench } from "lucide-react";

import { ConsultationCta } from "@/components/home/consultation-cta";
import { SiteFooter } from "@/components/site-footer";
import { SiteHeader } from "@/components/site-header";
import { getLivingRoomSpaceArticleHref, livingRoomSpaceArticles } from "@/data/living-room-space-articles";

export const metadata: Metadata = {
  title: "Không gian phòng khách | Tổ Ấm Hoàn Hảo",
  description:
    "Tổng hợp các bài viết về thiết kế, thi công không gian phòng khách: biệt thự, nhà phố, chung cư hiện đại và sang trọng.",
};

const services = [
  { icon: Armchair, title: "Thiết kế phòng khách", content: "Tư vấn thiết kế không gian phòng khách theo phong cách và nhu cầu sử dụng." },
  { icon: Sofa, title: "Bố trí nội thất", content: "Bố trí sofa, kệ tivi, bàn trà và các đồ nội thất hài hòa, hợp lý." },
  { icon: Wrench, title: "Thi công trọn gói", content: "Thi công không gian phòng khách từ phần thô đến hoàn thiện." },
  { icon: Factory, title: "Sản xuất đồ gỗ", content: "Sofa, tủ kệ và đồ gỗ nội thất gia công theo yêu cầu." },
];

export default function LivingRoomSpacePage() {
  return (
    <main className="min-h-screen bg-[#f8f3ec] text-[#2d271f]">
      <section className="relative overflow-hidden border-b border-[#e1d6c7]">
        ...
        <div className="mx-auto grid min-h-[560px] max-w-[1320px] pt-20 lg:grid-cols-[0.88fr_1.12fr] xl:pt-[120px]">
          <div className="relative z-10 flex items-center px-6 py-16 sm:px-10 lg:px-8 lg:py-12">
            <div className="max-w-[560px]">
              <nav aria-label="Điều hướng trang" className="text-xs text-[#766d60]">
                ...
                <span className="mx-3">/</span>
                <span>Không gian phòng khách</span>
              </nav>
          ...
          <div className="relative min-h-[340px] lg:min-h-full">
            <Image src="/images/thi-cong-noi-that/khong-gian-phong-khach/bai-1-thumb.webp" alt="Không gian phòng khách" fill priority sizes="(min-width: 1024px) 56vw, 100vw" className="object-cover" />
        ...
        <div className="mx-auto max-w-[1320px]">
          <div className="max-w-[930px]">
            ...
            <h2 className="mt-3 font-serif text-4xl leading-tight text-[#30291f] sm:text-5xl">
              Thư viện mẫu thiết kế và thi công không gian phòng khách
            </h2>
            <p className="mt-5 max-w-[760px] text-sm leading-7 text-[#6f6558]">
              Tổng hợp các bài viết về không gian phòng khách từ website cũ, giúp bạn tham khảo kiểu dáng, chất liệu
              và phong cách trước khi đưa ra quyết định cho công trình của mình.
            </p>
          </div>

          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {livingRoomSpaceArticles.map((item, index) => (
              <Link
                key={item.slug}
                href={item.externalHref ?? getLivingRoomSpaceArticleHref(item.slug)}
      ...
      <section className="border-y border-[#e1d6c7] bg-[#fdfaf6] px-5 py-16 sm:px-8 lg:py-20">
        <div className="mx-auto max-w-[1320px]">
          <div className="text-center">
            <p className="text-xs font-bold uppercase tracking-[0.18em] text-[#9a733e]">Dịch vụ thi công phòng khách</p>
            <h2 className="mt-3 font-serif text-4xl text-[#30291f]">Từ thiết kế đến hoàn thiện không gian phòng khách</h2>
          </div>
      ...
      <section className="relative overflow-hidden bg-[#3d382d] px-5 py-16 text-white sm:px-8 lg:py-20">
        <div className="relative mx-auto flex max-w-[1120px] flex-col items-center text-center">
          <Sofa aria-hidden="true" className="h-9 w-9 text-[#e6c897]" strokeWidth={1.25} />
          <h2 className="mt-4 max-w-[760px] font-serif text-4xl leading-tight sm:text-5xl">
            Sẵn sàng kiến tạo không gian phòng khách cho tổ ấm của bạn?
          </h2>
          <p className="mt-5 max-w-[680px] text-sm leading-7 text-[#e8e0d5]">
            Liên hệ ngay để được tư vấn và báo giá thiết kế, thi công không gian phòng khách phù hợp nhất.
          </p>
